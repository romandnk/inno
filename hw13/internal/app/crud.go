...
func Run() {
	...
	authServiceApiKey := os.Getenv("AUTH_SERVICE_KEY")
	if authServiceApiKey == "" {
		log.Fatal("no AUTH_SERVICE_KEY environment variable")
	}
	...
	authclient.Init("localhost:8000", authServiceApiKey)
